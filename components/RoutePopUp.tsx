import { View, Text, Alert, Modal, Pressable, StyleSheet, TouchableOpacity, TouchableWithoutFeedback } from 'react-native'
...
function RoutePopUp({modalVisible, hideModal, editRoute, deleteRoute, routeId}: RoutePopUpProps) {
